...
/* harmony export */ });
/* harmony import */ var _assets_onepiece_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/onepiece.jpg */ "./src/assets/onepiece.jpg");
/* harmony import */ var _dynamicList_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dynamicList.js */ "./src/module/dynamicList.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return exports; }; var exports = {}, Op = Object.prototype, hasOwn = Op.hasOwnProperty, defineProperty = Object.defineProperty || function (obj, key, desc) { obj[key] = desc.value; }, $Symbol = "function" == typeof Symbol ? Symbol : {}, iteratorSymbol = $Symbol.iterator || "@@iterator", asyncIteratorSymbol = $Symbol.asyncIterator || "@@asyncIterator", toStringTagSymbol = $Symbol.toStringTag || "@@toStringTag"; function define(obj, key, value) { return Object.defineProperty(obj, key, { value: value, enumerable: !0, configurable: !0, writable: !0 }), obj[key]; } try { define({}, ""); } catch (err) { define = function define(obj, key, value) { return obj[key] = value; }; } function wrap(innerFn, outerFn, self, tryLocsList) { var protoGenerator = outerFn && outerFn.prototype instanceof Generator ? outerFn : Generator, generator = Object.create(protoGenerator.prototype), context = new Context(tryLocsList || []); return defineProperty(generator, "_invoke", { value: makeInvokeMethod(innerFn, self, context) }), generator; } function tryCatch(fn, obj, arg) { try { return { type: "normal", arg: fn.call(obj, arg) }; } catch (err) { return { type: "throw", arg: err }; } } exports.wrap = wrap; var ContinueSentinel = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var IteratorPrototype = {}; define(IteratorPrototype, iteratorSymbol, function () { return this; }); var getProto = Object.getPrototypeOf, NativeIteratorPrototype = getProto && getProto(getProto(values([]))); NativeIteratorPrototype && NativeIteratorPrototype !== Op && hasOwn.call(NativeIteratorPrototype, iteratorSymbol) && (IteratorPrototype = NativeIteratorPrototype); var Gp = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(IteratorPrototype); function defineIteratorMethods(prototype) { ["next", "throw", "return"].forEach(function (method) { define(prototype, method, function (arg) { return this._invoke(method, arg); }); }); } function AsyncIterator(generator, PromiseImpl) { function invoke(method, arg, resolve, reject) { var record = tryCatch(generator[method], generator, arg); if ("throw" !== record.type) { var result = record.arg, value = result.value; return value && "object" == _typeof(value) && hasOwn.call(value, "__await") ? PromiseImpl.resolve(value.__await).then(function (value) { invoke("next", value, resolve, reject); }, function (err) { invoke("throw", err, resolve, reject); }) : PromiseImpl.resolve(value).then(function (unwrapped) { result.value = unwrapped, resolve(result); }, function (error) { return invoke("throw", error, resolve, reject); }); } reject(record.arg); } var previousPromise; defineProperty(this, "_invoke", { value: function value(method, arg) { function callInvokeWithMethodAndArg() { return new PromiseImpl(function (resolve, reject) { invoke(method, arg, resolve, reject); }); } return previousPromise = previousPromise ? previousPromise.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(innerFn, self, context) { var state = "suspendedStart"; return function (method, arg) { if ("executing" === state) throw new Error("Generator is already running"); if ("completed" === state) { if ("throw" === method) throw arg; return doneResult(); } for (context.method = method, context.arg = arg;;) { var delegate = context.delegate; if (delegate) { var delegateResult = maybeInvokeDelegate(delegate, context); if (delegateResult) { if (delegateResult === ContinueSentinel) continue; return delegateResult; } } if ("next" === context.method) context.sent = context._sent = context.arg;else if ("throw" === context.method) { if ("suspendedStart" === state) throw state = "completed", context.arg; context.dispatchException(context.arg); } else "return" === context.method && context.abrupt("return", context.arg); state = "executing"; var record = tryCatch(innerFn, self, context); if ("normal" === record.type) { if (state = context.done ? "completed" : "suspendedYield", record.arg === ContinueSentinel) continue; return { value: record.arg, done: context.done }; } "throw" === record.type && (state = "completed", context.method = "throw", context.arg = record.arg); } }; } function maybeInvokeDelegate(delegate, context) { var methodName = context.method, method = delegate.iterator[methodName]; if (undefined === method) return context.delegate = null, "throw" === methodName && delegate.iterator["return"] && (context.method = "return", context.arg = undefined, maybeInvokeDelegate(delegate, context), "throw" === context.method) || "return" !== methodName && (context.method = "throw", context.arg = new TypeError("The iterator does not provide a '" + methodName + "' method")), ContinueSentinel; var record = tryCatch(method, delegate.iterator, context.arg); if ("throw" === record.type) return context.method = "throw", context.arg = record.arg, context.delegate = null, ContinueSentinel; var info = record.arg; return info ? info.done ? (context[delegate.resultName] = info.value, context.next = delegate.nextLoc, "return" !== context.method && (context.method = "next", context.arg = undefined), context.delegate = null, ContinueSentinel) : info : (context.method = "throw", context.arg = new TypeError("iterator result is not an object"), context.delegate = null, ContinueSentinel); } function pushTryEntry(locs) { var entry = { tryLoc: locs[0] }; 1 in locs && (entry.catchLoc = locs[1]), 2 in locs && (entry.finallyLoc = locs[2], entry.afterLoc = locs[3]), this.tryEntries.push(entry); } function resetTryEntry(entry) { var record = entry.completion || {}; record.type = "normal", delete record.arg, entry.completion = record; } function Context(tryLocsList) { this.tryEntries = [{ tryLoc: "root" }], tryLocsList.forEach(pushTryEntry, this), this.reset(!0); } function values(iterable) { if (iterable) { var iteratorMethod = iterable[iteratorSymbol]; if (iteratorMethod) return iteratorMethod.call(iterable); if ("function" == typeof iterable.next) return iterable; if (!isNaN(iterable.length)) { var i = -1, next = function next() { for (; ++i < iterable.length;) if (hasOwn.call(iterable, i)) return next.value = iterable[i], next.done = !1, next; return next.value = undefined, next.done = !0, next; }; return next.next = next; } } return { next: doneResult }; } function doneResult() { return { value: undefined, done: !0 }; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, defineProperty(Gp, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), defineProperty(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, toStringTagSymbol, "GeneratorFunction"), exports.isGeneratorFunction = function (genFun) { var ctor = "function" == typeof genFun && genFun.constructor; return !!ctor && (ctor === GeneratorFunction || "GeneratorFunction" === (ctor.displayName || ctor.name)); }, exports.mark = function (genFun) { return Object.setPrototypeOf ? Object.setPrototypeOf(genFun, GeneratorFunctionPrototype) : (genFun.__proto__ = GeneratorFunctionPrototype, define(genFun, toStringTagSymbol, "GeneratorFunction")), genFun.prototype = Object.create(Gp), genFun; }, exports.awrap = function (arg) { return { __await: arg }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, asyncIteratorSymbol, function () { return this; }), exports.AsyncIterator = AsyncIterator, exports.async = function (innerFn, outerFn, self, tryLocsList, PromiseImpl) { void 0 === PromiseImpl && (PromiseImpl = Promise); var iter = new AsyncIterator(wrap(innerFn, outerFn, self, tryLocsList), PromiseImpl); return exports.isGeneratorFunction(outerFn) ? iter : iter.next().then(function (result) { return result.done ? result.value : iter.next(); }); }, defineIteratorMethods(Gp), define(Gp, toStringTagSymbol, "Generator"), define(Gp, iteratorSymbol, function () { return this; }), define(Gp, "toString", function () { return "[object Generator]"; }), exports.keys = function (val) { var object = Object(val), keys = []; for (var key in object) keys.push(key); return keys.reverse(), function next() { for (; keys.length;) { var key = keys.pop(); if (key in object) return next.value = key, next.done = !1, next; } return next.done = !0, next; }; }, exports.values = values, Context.prototype = { constructor: Context, reset: function reset(skipTempReset) { if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(resetTryEntry), !skipTempReset) for (var name in this) "t" === name.charAt(0) && hasOwn.call(this, name) && !isNaN(+name.slice(1)) && (this[name] = undefined); }, stop: function stop() { this.done = !0; var rootRecord = this.tryEntries[0].completion; if ("throw" === rootRecord.type) throw rootRecord.arg; return this.rval; }, dispatchException: function dispatchException(exception) { if (this.done) throw exception; var context = this; function handle(loc, caught) { return record.type = "throw", record.arg = exception, context.next = loc, caught && (context.method = "next", context.arg = undefined), !!caught; } for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i], record = entry.completion; if ("root" === entry.tryLoc) return handle("end"); if (entry.tryLoc <= this.prev) { var hasCatch = hasOwn.call(entry, "catchLoc"), hasFinally = hasOwn.call(entry, "finallyLoc"); if (hasCatch && hasFinally) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } else if (hasCatch) { if (this.prev < entry.catchLoc) return handle(entry.catchLoc, !0); } else { if (!hasFinally) throw new Error("try statement without catch or finally"); if (this.prev < entry.finallyLoc) return handle(entry.finallyLoc); } } } }, abrupt: function abrupt(type, arg) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc <= this.prev && hasOwn.call(entry, "finallyLoc") && this.prev < entry.finallyLoc) { var finallyEntry = entry; break; } } finallyEntry && ("break" === type || "continue" === type) && finallyEntry.tryLoc <= arg && arg <= finallyEntry.finallyLoc && (finallyEntry = null); var record = finallyEntry ? finallyEntry.completion : {}; return record.type = type, record.arg = arg, finallyEntry ? (this.method = "next", this.next = finallyEntry.finallyLoc, ContinueSentinel) : this.complete(record); }, complete: function complete(record, afterLoc) { if ("throw" === record.type) throw record.arg; return "break" === record.type || "continue" === record.type ? this.next = record.arg : "return" === record.type ? (this.rval = this.arg = record.arg, this.method = "return", this.next = "end") : "normal" === record.type && afterLoc && (this.next = afterLoc), ContinueSentinel; }, finish: function finish(finallyLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.finallyLoc === finallyLoc) return this.complete(entry.completion, entry.afterLoc), resetTryEntry(entry), ContinueSentinel; } }, "catch": function _catch(tryLoc) { for (var i = this.tryEntries.length - 1; i >= 0; --i) { var entry = this.tryEntries[i]; if (entry.tryLoc === tryLoc) { var record = entry.completion; if ("throw" === record.type) { var thrown = record.arg; resetTryEntry(entry); } return thrown; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(iterable, resultName, nextLoc) { return this.delegate = { iterator: values(iterable), resultName: resultName, nextLoc: nextLoc }, "next" === this.method && (this.arg = undefined), ContinueSentinel; } }, exports; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          api.map(function (each, idx) {
            ...
            // anidata.aniId.push(each.mal_id);
            // anidata.aniTitle.push(each.title_english);
            // anidata.aniImg.push(each.images.jpg.image_url);
          });
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\r\n  margin: 0;\r\n  padding: 0;\r\n  box-sizing: border-box;\r\n  font-family: \"Itim\", cursive;\r\n}\r\n\r\nbody {\r\n  background-image: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\r\n}\r\n\r\nbody.modal-active {\r\n  height: 100vh;\r\n  overflow: hidden;\r\n}\r\n\r\n.nav {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  padding: 0.5rem 5rem;\r\n  background-color: black;\r\n  position: fixed;\r\n  z-index: 2;\r\n  right: 0;\r\n  left: 0;\r\n  top: 0;\r\n}\r\n\r\nh2 {\r\n  color: white;\r\n  font-size: 3.5rem;\r\n}\r\n\r\nul {\r\n  display: flex;\r\n  list-style: none;\r\n}\r\n\r\nul li {\r\n  margin: 0 20px;\r\n}\r\n\r\nul li a {\r\n  text-decoration: none;\r\n  color: red;\r\n  font-size: 1.5rem;\r\n}\r\n\r\n.animes {\r\n  padding: 100px;\r\n}\r\n\r\n.animes h3 {\r\n  margin: 20px;\r\n  font-size: 3rem;\r\n  color: white;\r\n  text-align: center;\r\n}\r\n\r\n.show {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.likes-btn {\r\n  display: inline-block;\r\n  border: none;\r\n  background-color: transparent;\r\n  cursor: pointer;\r\n}\r\n\r\n.likes-btn svg {\r\n  width: 2.5em;\r\n  height: 2.5em;\r\n  fill: #ccc;\r\n}\r\n\r\n.likes-btn.liked svg {\r\n  fill: #f00;\r\n}\r\n\r\n.likes-count {\r\n  color: white;\r\n  padding-bottom: 12px;\r\n}\r\n\r\n.comments {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.main-anime-container {\r\n  display: grid;\r\n  grid-template-columns: repeat(3, 1fr);\r\n  grid-gap: 20px;\r\n  align-items: center;\r\n}\r\n\r\n.display {\r\n  display: flex;\r\n  flex-direction: column;\r\n  margin: 30px;\r\n  padding: 20px;\r\n  background-color: maroon;\r\n  border-radius: 10px;\r\n  box-shadow: 0 0 10px white;\r\n}\r\n\r\n.display .image-display {\r\n  border-radius: 10px;\r\n  width: 100%;\r\n  height: 250px;\r\n}\r\n\r\n.description {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.display .description {\r\n  display: flex;\r\n  justify-content: space-around;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.description .title-display {\r\n  font-size: 3.5rem;\r\n  color: green;\r\n  margin-bottom: 20px;\r\n}\r\n\r\n.display .description .title-display {\r\n  font-size: 2rem;\r\n  color: whitesmoke;\r\n}\r\n\r\n.comment-btn {\r\n  display: flex;\r\n  border: none;\r\n  background-color: whitesmoke;\r\n  cursor: pointer;\r\n  padding: 10px 20px;\r\n  border-radius: 10px;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: auto;\r\n  color: red;\r\n  font-size: 1.2rem;\r\n  font-weight: 500;\r\n  box-shadow: 0 0 10px white;\r\n}\r\n\r\n.footer {\r\n  position: fixed;\r\n  z-index: 3;\r\n  right: 0;\r\n  left: 0;\r\n  bottom: 0;\r\n  text-align: center;\r\n  background-color: black;\r\n  color: whitesmoke;\r\n  padding: 20px;\r\n  font-size: 1.2rem;\r\n}\r\n\r\n/* modal start */\r\n.modal {\r\n  width: 100%;\r\n  height: 100vh;\r\n  background-color: rgba(255, 255, 255, 0.8);\r\n  padding: 5%;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  row-gap: 20px;\r\n  position: fixed;\r\n  left: 0;\r\n  top: 0;\r\n  z-index: 5;\r\n  overflow-y: scroll;\r\n\r\n  display: none;\r\n}\r\n\r\n.close-btn {\r\n  background-color: transparent;\r\n  font-size: 2em;\r\n  border: none;\r\n  position: absolute;\r\n  right: 5%;\r\n  top: 3%;\r\n  cursor: pointer;\r\n}\r\n\r\n.close-btn:hover {\r\n  color: maroon;\r\n}\r\n\r\n.img-container {\r\n  width: 30%;\r\n  height: 40vh;\r\n}\r\n\r\n.popup-img {\r\n  width: 100%;\r\n  height: 100%;\r\n  object-fit: cover;\r\n  object-position: center;\r\n}\r\n\r\n.info-container {\r\n  width: 100%;\r\n  text-align: center;\r\n}\r\n\r\ntable,\r\ntbody {\r\n  width: 100%;\r\n  display: inline-block;\r\n\r\n  text-align: left;\r\n}\r\n\r\ntr {\r\n  width: 100%;\r\n  display: inline-block;\r\n  display: grid;\r\n  grid-template-columns: 10% 85%;\r\n  column-gap: 10px;\r\n  margin: 10px 0;\r\n}\r\n\r\ntr td:first-child {\r\n  grid-column: 1 / span 1;\r\n  display: flex;\r\n  justify-content: space-between;\r\n}\r\n\r\n.cmt-container,\r\n.cmt-form {\r\n  width: 100%;\r\n  text-align: left;\r\n}\r\n\r\n.cmt-container h2,\r\n.cmt-form h2 {\r\n  color: #000;\r\n  font-size: 1.5em;\r\n  text-align: center;\r\n}\r\n\r\n.form-control {\r\n  background: transparent;\r\n  border: none;\r\n  border-bottom: 1px solid #000;\r\n  margin: 10px 0;\r\n}\r\n\r\n.cmt-btn {\r\n  background-color: transparent;\r\n  padding: 3px;\r\n  cursor: pointer;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAEA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;EACtB,4BAA4B;AAC9B;;AAEA;EACE,yDAA2C;AAC7C;;AAEA;EACE,aAAa;EACb,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,oBAAoB;EACpB,uBAAuB;EACvB,eAAe;EACf,UAAU;EACV,QAAQ;EACR,OAAO;EACP,MAAM;AACR;;AAEA;EACE,YAAY;EACZ,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,gBAAgB;AAClB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,qBAAqB;EACrB,UAAU;EACV,iBAAiB;AACnB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,YAAY;EACZ,eAAe;EACf,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,qBAAqB;EACrB,YAAY;EACZ,6BAA6B;EAC7B,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,UAAU;AACZ;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,YAAY;EACZ,oBAAoB;AACtB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,qCAAqC;EACrC,cAAc;EACd,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,YAAY;EACZ,aAAa;EACb,wBAAwB;EACxB,mBAAmB;EACnB,0BAA0B;AAC5B;;AAEA;EACE,mBAAmB;EACnB,WAAW;EACX,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,iBAAiB;EACjB,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,4BAA4B;EAC5B,eAAe;EACf,kBAAkB;EAClB,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;EACZ,UAAU;EACV,iBAAiB;EACjB,gBAAgB;EAChB,0BAA0B;AAC5B;;AAEA;EACE,eAAe;EACf,UAAU;EACV,QAAQ;EACR,OAAO;EACP,SAAS;EACT,kBAAkB;EAClB,uBAAuB;EACvB,iBAAiB;EACjB,aAAa;EACb,iBAAiB;AACnB;;AAEA,gBAAgB;AAChB;EACE,WAAW;EACX,aAAa;EACb,0CAA0C;EAC1C,WAAW;EACX,sBAAsB;EACtB,mBAAmB;EACnB,aAAa;EACb,eAAe;EACf,OAAO;EACP,MAAM;EACN,UAAU;EACV,kBAAkB;;EAElB,aAAa;AACf;;AAEA;EACE,6BAA6B;EAC7B,cAAc;EACd,YAAY;EACZ,kBAAkB;EAClB,SAAS;EACT,OAAO;EACP,eAAe;AACjB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,UAAU;EACV,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,iBAAiB;EACjB,uBAAuB;AACzB;;AAEA;EACE,WAAW;EACX,kBAAkB;AACpB;;AAEA;;EAEE,WAAW;EACX,qBAAqB;;EAErB,gBAAgB;AAClB;;AAEA;EACE,WAAW;EACX,qBAAqB;EACrB,aAAa;EACb,8BAA8B;EAC9B,gBAAgB;EAChB,cAAc;AAChB;;AAEA;EACE,uBAAuB;EACvB,aAAa;EACb,8BAA8B;AAChC;;AAEA;;EAEE,WAAW;EACX,gBAAgB;AAClB;;AAEA;;EAEE,WAAW;EACX,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,uBAAuB;EACvB,YAAY;EACZ,6BAA6B;EAC7B,cAAc;AAChB;;AAEA;EACE,6BAA6B;EAC7B,YAAY;EACZ,eAAe;AACjB","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Itim&display=swap\");\r\n\r\n* {\r\n  margin: 0;\r\n  padding: 0;\r\n  box-sizing: border-box;\r\n  font-family: \"Itim\", cursive;\r\n}\r\n\r\nbody {\r\n  background-image: url(./assets/bgImage.jpg);\r\n}\r\n\r\nbody.modal-active {\r\n  height: 100vh;\r\n  overflow: hidden;\r\n}\r\n\r\n.nav {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  padding: 0.5rem 5rem;\r\n  background-color: black;\r\n  position: fixed;\r\n  z-index: 2;\r\n  right: 0;\r\n  left: 0;\r\n  top: 0;\r\n}\r\n\r\nh2 {\r\n  color: white;\r\n  font-size: 3.5rem;\r\n}\r\n\r\nul {\r\n  display: flex;\r\n  list-style: none;\r\n}\r\n\r\nul li {\r\n  margin: 0 20px;\r\n}\r\n\r\nul li a {\r\n  text-decoration: none;\r\n  color: red;\r\n  font-size: 1.5rem;\r\n}\r\n\r\n.animes {\r\n  padding: 100px;\r\n}\r\n\r\n.animes h3 {\r\n  margin: 20px;\r\n  font-size: 3rem;\r\n  color: white;\r\n  text-align: center;\r\n}\r\n\r\n.show {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.likes-btn {\r\n  display: inline-block;\r\n  border: none;\r\n  background-color: transparent;\r\n  cursor: pointer;\r\n}\r\n\r\n.likes-btn svg {\r\n  width: 2.5em;\r\n  height: 2.5em;\r\n  fill: #ccc;\r\n}\r\n\r\n.likes-btn.liked svg {\r\n  fill: #f00;\r\n}\r\n\r\n.likes-count {\r\n  color: white;\r\n  padding-bottom: 12px;\r\n}\r\n\r\n.comments {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.main-anime-container {\r\n  display: grid;\r\n  grid-template-columns: repeat(3, 1fr);\r\n  grid-gap: 20px;\r\n  align-items: center;\r\n}\r\n\r\n.display {\r\n  display: flex;\r\n  flex-direction: column;\r\n  margin: 30px;\r\n  padding: 20px;\r\n  background-color: maroon;\r\n  border-radius: 10px;\r\n  box-shadow: 0 0 10px white;\r\n}\r\n\r\n.display .image-display {\r\n  border-radius: 10px;\r\n  width: 100%;\r\n  height: 250px;\r\n}\r\n\r\n.description {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.display .description {\r\n  display: flex;\r\n  justify-content: space-around;\r\n  align-items: center;\r\n  margin: 20px;\r\n}\r\n\r\n.description .title-display {\r\n  font-size: 3.5rem;\r\n  color: green;\r\n  margin-bottom: 20px;\r\n}\r\n\r\n.display .description .title-display {\r\n  font-size: 2rem;\r\n  color: whitesmoke;\r\n}\r\n\r\n.comment-btn {\r\n  display: flex;\r\n  border: none;\r\n  background-color: whitesmoke;\r\n  cursor: pointer;\r\n  padding: 10px 20px;\r\n  border-radius: 10px;\r\n  justify-content: center;\r\n  align-items: center;\r\n  margin: auto;\r\n  color: red;\r\n  font-size: 1.2rem;\r\n  font-weight: 500;\r\n  box-shadow: 0 0 10px white;\r\n}\r\n\r\n.footer {\r\n  position: fixed;\r\n  z-index: 3;\r\n  right: 0;\r\n  left: 0;\r\n  bottom: 0;\r\n  text-align: center;\r\n  background-color: black;\r\n  color: whitesmoke;\r\n  padding: 20px;\r\n  font-size: 1.2rem;\r\n}\r\n\r\n/* modal start */\r\n.modal {\r\n  width: 100%;\r\n  height: 100vh;\r\n  background-color: rgba(255, 255, 255, 0.8);\r\n  padding: 5%;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  row-gap: 20px;\r\n  position: fixed;\r\n  left: 0;\r\n  top: 0;\r\n  z-index: 5;\r\n  overflow-y: scroll;\r\n\r\n  display: none;\r\n}\r\n\r\n.close-btn {\r\n  background-color: transparent;\r\n  font-size: 2em;\r\n  border: none;\r\n  position: absolute;\r\n  right: 5%;\r\n  top: 3%;\r\n  cursor: pointer;\r\n}\r\n\r\n.close-btn:hover {\r\n  color: maroon;\r\n}\r\n\r\n.img-container {\r\n  width: 30%;\r\n  height: 40vh;\r\n}\r\n\r\n.popup-img {\r\n  width: 100%;\r\n  height: 100%;\r\n  object-fit: cover;\r\n  object-position: center;\r\n}\r\n\r\n.info-container {\r\n  width: 100%;\r\n  text-align: center;\r\n}\r\n\r\ntable,\r\ntbody {\r\n  width: 100%;\r\n  display: inline-block;\r\n\r\n  text-align: left;\r\n}\r\n\r\ntr {\r\n  width: 100%;\r\n  display: inline-block;\r\n  display: grid;\r\n  grid-template-columns: 10% 85%;\r\n  column-gap: 10px;\r\n  margin: 10px 0;\r\n}\r\n\r\ntr td:first-child {\r\n  grid-column: 1 / span 1;\r\n  display: flex;\r\n  justify-content: space-between;\r\n}\r\n\r\n.cmt-container,\r\n.cmt-form {\r\n  width: 100%;\r\n  text-align: left;\r\n}\r\n\r\n.cmt-container h2,\r\n.cmt-form h2 {\r\n  color: #000;\r\n  font-size: 1.5em;\r\n  text-align: center;\r\n}\r\n\r\n.form-control {\r\n  background: transparent;\r\n  border: none;\r\n  border-bottom: 1px solid #000;\r\n  margin: 10px 0;\r\n}\r\n\r\n.cmt-btn {\r\n  background-color: transparent;\r\n  padding: 3px;\r\n  cursor: pointer;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
